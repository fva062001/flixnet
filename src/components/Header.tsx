...
function Header() {
  return (
    <>
      <div
        className="relative z-10 sm:hidden md:inline-block"
        style={{
          width: '100vw',
          height: '100vh',
          background: `linear-gradient(to top, rgba(20, 20, 20, 1) 0%, rgba(20, 20, 20, 0.5) 80%, rgba(0, 0, 0, 0) 100%), url(${backgroundImage.src})`,
      ...
      <div
        className="relative z-10 mx-auto mt-24 rounded-2xl border-[0.1px]  border-[#49524f] sm:inline-block md:hidden"
        style={{
          width: '90vw',
          height: '60vh',
